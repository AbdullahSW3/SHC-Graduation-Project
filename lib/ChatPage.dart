...
class _ChatPageState extends State<ChatPage> {
  ...
  void _seeDoctortInfo(id){

    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) =>  DoctorMedicalRecord(id: id)),
    );
  }
          ...
          IconButton(
            ...
            icon: PopupMenuButton<int>(
              itemBuilder: (BuildContext context) => [
                ...
                PopupMenuItem(
                  value: 1,
                  child: Text('View Doctor Profile', style: appText(
                      color: Colors.black,
                      isShadow: false,
                      weight: FontWeight.w600,
                      size: 16)),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const Spacer(),
                StreamBuilder(
                  stream: firestore.collection('doctors').doc(widget.id).snapshots(),
