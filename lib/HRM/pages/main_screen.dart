...
import 'package:gp/HRM/models/bpm.dart';
import 'package:gp/HRM/models/line_titles.dart';
import 'package:gp/HRM/networking/firebase_api.dart';
import 'package:gp/HRM/networking/heart_rate_api.dart';
import 'package:gp/HRM/pages/background.dart';
import 'package:camera/camera.dart';
import 'package:gp/HRM/pages/test_screen.dart';
import 'package:gp/HRM/utils/color_detector.dart';
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Container(
                            child: Text(
                              "A normal resting heart rate for adults ranges from 60 to 100 beats per minute.\n\n A resting heart rate that falls outside the range of 60 to 100 beats per minute for adults is considered abnormal.",
                              style: appText(
                                color: Colors.white,
                                isShadow: true,
                                size: 20,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: LottieBuilder.asset("jsons/nodata.json"),
          ),
          Text(
