...
class _DescriptionState extends State<Description> {
  ...
  void getDescription(String value){
    for (var item in description.entries) {
      if (item.key == value){
        diagnosisDescription = item.value;
      }
    }
  }

  void getPrecautions(String value){
    for (var item in precautions.entries) {
      if (item.key == value){
        diagnosisPrecautions = item.value;
      }
    }
  }
  bool _isLoading = true;
  String diagnosisDescription = '';
  String diagnosisPrecautions = '';
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    String diagnosis = args['diagnosis'];
    getDescription(diagnosis);
    getPrecautions(diagnosis);

    if (diagnosis == "Peptic ulcer diseae" ){ // ignore this
      diagnosis = "Peptic ulcer disease";
    }

    return Scaffold(
      appBar: AppBar(
        title: Text("Description", style: appText(
            color: Colors.white,
            isShadow: false,
